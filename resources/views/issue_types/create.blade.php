    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <form action="{{ route('issue-types.store') }}" method="POST" class="p-6">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" name="issue_type_id" value="{{ old('issue_type_id') }}"
                                placeholder="ถ้าไม่ระบุ ระบบจะกำหนดให้อัตโนมัติ"
                                min="1"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition duration-200 @error('issue_type_id') border-red-500 @enderror">
