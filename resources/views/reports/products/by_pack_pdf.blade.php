...
<head>
    <meta charset="utf-8">
    <title>รายละเอียดตาม Pack</title>
    <style>
        body { font-family: 'garuda', sans-serif; font-size: 10pt; }
        h2 { text-align: center; margin-bottom: 10px; }
        h3 { background-color: #dcfce7; color: #166534; padding: 6px 10px; margin: 15px 0 5px 0; font-size: 11pt; }
...
<body>
    <h2>รายงานรายละเอียดสินค้าตาม Pack{{ $pack ? ': ' . $pack : ' (ทั้งหมด)' }}</h2>
