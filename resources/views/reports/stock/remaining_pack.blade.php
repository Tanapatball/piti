<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">รายงานสินค้าคงเหลือ ณ ปัจจุบัน/Pack</h2>
    </x-slot>

    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-lg p-6">
            <form method="GET" action="{{ route('reports.stock-remaining-pack') }}" class="flex flex-wrap gap-4 mb-6 items-end">
            ...
            <div class="overflow-x-auto">
                @foreach($grouped as $pack => $products)
                <h3 class="text-lg font-bold mt-6 mb-2 bg-gray-100 px-4 py-2 rounded">Pack: {{ $pack }}</h3>
