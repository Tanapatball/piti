    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <form action="{{ route('receive-types.store') }}" method="POST" class="p-6">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" name="receive_type_id" value="{{ old('receive_type_id') }}"
                                placeholder="ถ้าไม่ระบุ ระบบจะกำหนดให้อัตโนมัติ"
                                min="1"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition duration-200 @error('receive_type_id') border-red-500 @enderror">
                            <p class="text-sm text-gray-500 flex items-center gap-1">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                ถ้าไม่ระบุ ระบบจะกำหนดให้อัตโนมัติ
                            </p>
                            @error('receive_type_id')
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                placeholder="เช่น รับจากซัพพลายเออร์, รับคืนจากลูกค้า"
